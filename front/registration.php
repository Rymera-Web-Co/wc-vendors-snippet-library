 ...
 * @return string
 */
function wcv_add_apply_vendor_label_css_class( $class ) {
	$class .= 'example_css_class';

	return $class;
}
add_filter( 'wcvendors_vendor_registration_apply_label_css_classes', 'wcv_add_apply_vendor_label_css_class', 10, 1 );
 ...
 * @return string
 */
function wcv_add_term_label_css_class( $class ) {
	$class .= 'example_css_class';

	return $class;
}
add_filter( 'wcvendors_vendor_registration_term_label_css_classes', 'wcv_add_term_label_css_class', 10, 1 );